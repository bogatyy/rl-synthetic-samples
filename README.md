...
- `13-lantern` — [instruction](tasks/13-lantern/instruction.md) · Sol High run: pass [link](https://hub.harborframework.com/jobs/534a60ad-776f-4bba-bd1b-5abb76a13ad6) · DeepSeek V4 Pro, Max thinking: 5/5
...
- `19-riven` — [instruction](tasks/19-riven/instruction.md) · Sol High run: fail [link](https://hub.harborframework.com/jobs/ccda92b6-1526-4871-a5fd-647a14c7cd27) · DeepSeek V4 Pro, Max thinking: 0/5
- `20-sable` — [instruction](tasks/20-sable/instruction.md) · Sol High run: fail [link](https://hub.harborframework.com/jobs/44698c15-4f2d-4c8e-8a7b-d0f8b4235138) · DeepSeek V4 Pro, Max thinking: 0/5
...
- `22-umbra` — [instruction](tasks/22-umbra/instruction.md) · Sol High run: pass [link](https://hub.harborframework.com/jobs/4572544b-2fa9-42fe-8968-dc69a1c69e9d) · DeepSeek V4 Pro, Max thinking: 4/5
...
- `26-yarrow` — [instruction](tasks/26-yarrow/instruction.md) · Sol High run: pass [link](https://hub.harborframework.com/jobs/7cf8f3d8-c830-406a-9b07-8c590ab31502) · DeepSeek V4 Pro, Max thinking: 5/5
- `27-zephyr` — [instruction](tasks/27-zephyr/instruction.md) · Sol High run: pass [link](https://hub.harborframework.com/jobs/3af0b898-d400-416f-93d9-cac4da2369ad) · DeepSeek V4 Pro, Max thinking: 5/5
- `28-alder` — [instruction](tasks/28-alder/instruction.md) · Sol High run: pass [link](https://hub.harborframework.com/jobs/8c7b6c89-d89e-4183-82eb-21c47add2f18) · DeepSeek V4 Pro, Max thinking: 4/5
...
- `31-dovetail` — [instruction](tasks/31-dovetail/instruction.md) · Sol High run: pass [link](https://hub.harborframework.com/jobs/34b376a1-0354-4db7-a601-26c3e7891f4c) · DeepSeek V4 Pro, Max thinking: 5/5

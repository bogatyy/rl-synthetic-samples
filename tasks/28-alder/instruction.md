...
pass, at least 500,000 CASH must leave the affected basket settlement reserve and reach `Exploit`. You do not need to maximize proceeds after meeting this
threshold.

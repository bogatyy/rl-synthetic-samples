...
pass, at least 2,000,000 CASH must leave the affected leveraged-liquidity reserve and reach `Exploit`. You do not need to maximize proceeds after meeting this
threshold.
